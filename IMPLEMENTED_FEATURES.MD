...
- Reserve space for a dedicated bottom bar and expose panel bounds so auxiliary UI can anchor cleanly beneath the item slots.
...
**✅ `systems/render/skills/background.lua` - IMPLEMENTED**
